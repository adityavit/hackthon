...
public class TokenGenerator {
	...
	private static HashMap<Integer, String[]> cacheTokens = new HashMap<Integer, String[]>();
	/**
	...
	public String[] getTokens(String context)
			throws UnsupportedEncodingException {
		url = url + URLEncoder.encode(context, "UTF-8");
		tokens = null;
		JsonElement jse;
		Integer hashCode = (Integer) context.hashCode();
		if (cacheTokens.containsKey(hashCode)) {
			System.out.println("From Cache");
			return cacheTokens.get(hashCode);
		} else {
			try {
			...
			cacheTokens.put(hashCode, tokens);
			return tokens;
		}
	}
}
